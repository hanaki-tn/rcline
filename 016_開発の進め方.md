...
### Phase A: 最小限VPS移行（最優先）

#### A-1. VPS環境への反映手順

**1. URLパス変更対応**
- 本番URL: `https://awf.technavigation.jp/rcline/*`
- 管理画面: `https://awf.technavigation.jp/rcline/admin/admin-demo.html`
- LIFF画面: `https://awf.technavigation.jp/rcline/liff/index.html`
...
# VPS用 .env
NODE_ENV=production
FILES_PUBLIC_URL_BASE=https://awf.technavigation.jp/rcline/files
DEV_ALLOW_INSECURE=0  # 署名検証有効
